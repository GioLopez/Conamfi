...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { age: @contacto.age, lastname: @contacto.lastname, name: @contacto.name } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { age: @contacto.age, lastname: @contacto.lastname, name: @contacto.name } }
